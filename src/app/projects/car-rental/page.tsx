// app/projects/car-rental/page.tsx
...
// Set this in Netlify env when Azure is live:
// NEXT_PUBLIC_CAR_RENTAL_URL=https://your-azure-site.azurewebsites.net
const LIVE_DEMO_URL = process.env.NEXT_PUBLIC_CAR_RENTAL_URL ?? "";
    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-black text-white">
      ...
      <section className="text-center py-20 px-4">
        ...
        <p className="text-lg max-w-3xl mx-auto mb-8 text-gray-300">
          ...
          <span className="font-semibold">SQL Server</span>. It supports Admin, Employee (Staff), and Customer roles with
          vehicle management, availability status, and a booking flow backed by a relational database.
        </p>

        <p className="text-sm max-w-2xl mx-auto text-gray-400">
          <span className="font-semibold">About the project:</span> I built this for my Computer Science NEA, and it
          played a huge role in helping me pass A Level Computer Science with a very good grade.
        </p>
      ...
      <section className="max-w-4xl mx-auto px-6 mb-12">
        <div className="rounded-2xl border border-yellow-400/30 bg-yellow-500/10 p-5">
          ...
          <p className="text-gray-200">
            Please <span className="font-semibold">do not use real personal details</span> when creating an account or
            filling out forms. Payments are simulated. If you need card details for testing, use these <i>fake</i>{" "}
            values:
          </p>
          <ul className="mt-3 text-gray-200 space-y-1">
            <li><span className="font-semibold">Cardholder Name:</span> John Sample</li>
            <li><span className="font-semibold">Card Number:</span> 4111 1111 1111 1111 <span className="text-gray-400">(digits only; only the last 4 are submitted)</span></li>
            <li><span className="font-semibold">Expiry:</span> 08/26</li>
            <li><span className="font-semibold">CVV:</span> 789</li>
          </ul>
          <p className="mt-3 text-gray-300">
            Payments are simulated with a <span className="font-semibold">50% chance</span> of success or failure.
            If your payment shows <span className="font-semibold">Failed</span>, just try again until it is successful.
          </p>
        </div>
      </section>
    ...
    >
      ...
      <section className="max-w-4xl mx-auto px-6 mb-12">
        ...
        <ul className="list-disc list-inside space-y-3 text-gray-300">
          <li>
            <span className="font-semibold">Role-based authentication</span> — Admin, Employee (Staff), and Customer
            permissions with protected areas.
          </li>
          <li>
            <span className="font-semibold">Vehicle management</span> — Staff can create, update, and retire cars from
            the fleet, and set status: <i>Available</i>, <i>Booked</i>, or <i>Maintenance</i> (this directly affects
            what Customers see).
          </li>
          <li>
      ...
      <section className="max-w-4xl mx-auto px-6 mb-16">
        ...
        <div className="mt-5 rounded-xl border border-blue-400/30 bg-blue-500/10 p-4">
          <p className="text-gray-200">
            ...
            Re-uploading is required to save the form.
          </p>
          <p className="text-gray-200 mt-2">
            Please use appropriate, real-model car images when trying the demo.
          </p>
        </div>
      </section>
      ...
      <section className="text-center mb-24 px-6">
        ...
        {LIVE_DEMO_URL ? (
          ...
          <button
            aria-disabled
            className="inline-block mt-2 bg-gray-700 text-white font-semibold px-6 py-3 rounded-xl shadow-lg cursor-not-allowed opacity-70"
            title="Coming soon"
          >
